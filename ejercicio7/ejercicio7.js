...
const totalScore = rpgVideogames.reduce((accumulator, videogame) => accumulator + videogame.score, 0);
const averageScore = totalScore / rpgVideogames.length;
console.log('La media de puntuaciones de los videojuegos RPG es:', averageScore);